...
<body class="d-md-flex">
    ...
    <div class="container-fluid mt-5">
        ...
        <div class="d-flex justify-content-center">
            <input type="text" class="form-control form-control-sm w-50" id="SearchAdmin" placeholder="Seach here...">
        ...
        <div class="table-responsive">
            <table class="table table-striped-columns table-bordered table-hover d-none" id="AdminTable" style="width: 100%;">
                <thead>
                    <tr>
