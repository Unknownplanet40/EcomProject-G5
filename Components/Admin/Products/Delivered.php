...
<body class="d-md-flex">
    ...
    <div class="container-fluid mt-5">
        ...
        <div class="d-flex justify-content-center">
            ...
            <button class="btn btn-sm btn-primary mx-1" id="updateselected" disabled hidden>
        ...
        <div class="table-responsive">
            <table class="table table-striped-columns table-bordered table-hover d-none" id="ProductTable" style="width: 100%;">
                ...
                <tbody class="table-group-divider" id="ProductTableBody">
                    <?php
                    $stmt = $conn->prepare("SELECT * FROM user_orders WHERE Status = 'Delivered' ORDER BY Created_At DESC");
                    $stmt->execute();
                    ...
                    ?>
                            <tr style="cursor: pointer;" class="table-row user-select-none">
                                ...
                                <td class="text-start"><?php echo $row_item['Total_Price'] ?>.00</td>
