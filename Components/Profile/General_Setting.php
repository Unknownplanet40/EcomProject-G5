        ...
        <div class="row">
            <div class="col-md-3">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class="mt-5 w-75 h-75 rounded-3" style="object-fit: cover; object-position: center;" id="profile-pic" src="../../Assets/Images/Profile.gif">
                    <span class="fw-bold mt-3 mb-2"><?php echo $Username; ?></span>
                    <span class="fs-6"><?php echo $Email; ?></span>
                    <div class="d-flex justify-content-between align-items-center mt-5 gap-2">
                        ...
                        <button class="btn btn-primary btn-sm" id="changeimage" type="button">Change Profile</button>
                ...
                <div class="p-3 py-5">
                    <div class="row g-3 bg-body-secondary p-3 rounded">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm" id="FirstName" placeholder="e.g. Juan">
                        </div>
                        <div class="col-md-6">
                            <label for="LastName" class="form-label">Last Name</label>
                            <input type="text" class="form-control form-control-sm" id="LastName" placeholder="e.g. Dela Cruz">
                        </div>
                        <div class="col-md-6">
                            <label for="Contact" class="form-label">Contact</label>
                            <input type="text" class="form-control form-control-sm" id="Contact" placeholder="e.g. 09XX-XXX-XXXX" maxlength="11">
                        </div>
                        <div class="col-md-6">
                            <label for="Gender" class="form-label">Gender</label>
                            <input type="text" class="form-control form-control-sm" id="Gender" placeholder="e.g. Male/Femail" list="GenderList" maxlength="6">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control form-control-sm" id="Email" placeholder="e.g. JuanDelaCrus@example.com">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class=" mt-1 text-end">
                            <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-trigger="hover" data-bs-title="This does not include the Password for security purposes">Update Details</button>
                        </div>
                    </div>
                    <div class="row g-3 bg-body-secondary p-3 mt-3 rounded">
                        ...
                        <div class="col-md-12">
                            <label for="HouseNo" class="form-label">House No. <small class="text-muted">Building, Street, etc.</small></label>
                        ...
                        <div class="text-end mt-3">
                            <button class="btn btn-primary btn-sm" type="button" id="UpdateAddress">Update Address</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <p class="text-muted mb-0">Current Theme: <small class="text-light" id="themeLabel">(Light Mode)</small></p>
                            <p class="text-light mb-0">Theme Preview for <span id="ThemePreviewLabel">Light Mode</span></p>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card mt-3 d-none" id="Ewallet">
                                <div class="card-body">
                                    ...
                                    <div class="text-end">
                                        <button class="btn btn-primary btn-sm" type="button" id="UpdateEwallet">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
