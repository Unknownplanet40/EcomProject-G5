        ...
        <div class="row">
            <div class="col-md-3">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class="mt-5 rounded-3" style="object-fit: cover; object-position: center;" width="150" height="150"
                        id="profile-pic" src="../../Assets/Images/Profile.gif">
            ...
            <div class="col-md-5">
                <div class="p-3 py-5">
                    <div class="row g-3 bg-body-secondary p-3 rounded">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control form-control-sm" id="Email"
                                placeholder="e.g. JuanDelaCrus@example.com" aria-describedby="E_FB updetails">
                        ...
                        <div class="col-md-12">
                            ...
                            <small class="text-muted mt-0">want to change password? <a
                                    class="text-primary text-decoration-none link-RP" id="CP">Click here</a></small>
                        </div>
                        <div class=" mt-1 text-end">
                            <button id="updetails" class="btn btn-success btn-sm" type="button" data-bs-toggle="tooltip"
                                data-bs-placement="right" data-bs-trigger="hover"
                                data-bs-title="This does not include the Password for security purposes">
                                <svg id="pass-v" width="16" height="16" role="img">
                    ...
                    <div class="row g-3 bg-body-secondary p-3 mt-3 rounded">
                        ...
                        <div class="col-md-12">
                            <label for="Landmark" class="form-label">Landmark <small
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <img src="../../Assets/Theme/LightMode.png" class="img-thumbnail" alt="Theme Preview"
                                id="ThemePreview" width="100%">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check form-check-reverse">
                                <input class="form-check-input" type="radio" name="PaymentMethod" value="Maya"
                                    id="Maya">
                            ...
                            <div class="card mt-3 d-none" id="Ewallet">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control form-control-sm" id="EwalletMail"
                                            placeholder="e.g. juandelacruz@gmail.com">
                                    </div>
                                    <div class="mb-3">
                                        <label for="EwalletNumber" class="form-label">Account Number</label>
                                        <input type="text" class="form-control form-control-sm" id="EwalletNumber"
                                            placeholder="e.g. 09XX-XXX-XXXX" maxlength="11">
                                    </div>
                                    <div class="text-end">
