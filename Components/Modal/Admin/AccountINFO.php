    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="details-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        ...
                        <div class="my-3 row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="First_Name" value="First Name" data-fname="" <?php echo ($CurrentPath == 'Account-Seller.php') ? 'disabled' : ''; ?>>
                            </div>
                            <div class="col-sm-5">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="Email_Address" value="Email Address" data-email="">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group has-validation">
                                    <input type="text" class="form-control" placeholder="Account Password" disabled id="Password">
                                ...
                                <small class="text-muted">Do you want to change the password?<span class="text-primary" style="cursor: pointer;" id="resetPass"> Click here</span></small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-2">
                                <label for="Gemder" class="form-label">Gender</label>
                                <input type="text" class="form-control" id="Gender" list="GenderList" placeholder="Choose Male or Femail" data-gender="" pattern="Male|Female">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control" id="Role" list="RoleList" data-role="" placeholder="Choose Account Role" pattern="admin|seller|user" <?php echo ($CurrentPath != 'Account-Admin.php') ? 'disabled' : ''; ?>>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" id="Contact" placeholder="09XX-XXX-XXXX" maxlength="11" data-contact="">
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="tab-pane fade" id="address-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="Province" placeholder="Province" data-province="">
                            </div>
                            <div class="col-md-6">
                                <label for="Municipality" class="form-label">Municipality <small class="text-muted">(City/Town/Municipality)</small></label>
                                <input type="text" class="form-control" id="Municipality" placeholder="Municipality" data-municipality="">
                            </div>
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="HouseNo" placeholder="1234 Main St" data-house="">
                            </div>
                            <div class="col-md-2">
                                <label for="Zipcode" class="form-label">Zip Code</label>
                                <input type="text" class="form-control" id="Zipcode" placeholder="Zip Code" maxlength="4" data-zip="">
                            </div>
                            <div class="col-md-5">
                                <label for="Barangay" class="form-label">Barangay</label>
                                <input type="text" class="form-control" id="Barangay" placeholder="Barangay" data-barangay="">
                            </div>
                            <div class="col-md-5">
                                <label for="Landmark" class="form-label">Landmark - (Optional)</label>
                                <input type="text" class="form-control" id="Landmark" placeholder="ex. Near the School" data-landmark="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer border-0">
                <button type="button" class="btn btn-sm btn-primary" id="SaveUser" data-stat1="false">Save changes</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" id="New_Email" placeholder="ex. juandelacrus@example.com" aria-describedby="NE_FB AddnewUser" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text" id="RandomPassword" style="cursor: pointer;" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-trigger="hover focus" data-bs-title="Generate Random Password">
                                <svg class="bi pe-none text-muted" width="16" height="16">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="New_Contact" placeholder="09XX-XXX-XXXX" maxlength="11" maxlength="11">
                    </div>
                    <div class="col-md-6">
                    </div>
                    <div class="col-md-4">
                        <label for="New_Role" class="form-label">Role</label>
                        <Select class="form-select" id="New_Role" <?php echo ($CurrentPath != 'Account-Admin.php') ? 'disabled' : ''; ?>>
                            <option selected hidden>Choose Account Role</option>
                            <option value="admin" <?php echo ($CurrentPath == 'Account-Admin.php') ? 'selected' : ''; ?>>Administator</option>
                            <option value="seller" <?php echo ($CurrentPath == 'Account-Seller.php') ? 'selected' : ''; ?>>Brand Seller</option>
                            <option value="user" <?php echo ($CurrentPath == 'Account-Users.php') ? 'selected' : ''; ?>>Customer</option>
                        </Select>
                    </div>
                    <div class="col-md-4">
                        <label for="New_Status" class="form-label">Status</label>
                        <Select class="form-select" id="New_Status" <?php echo ($CurrentPath != 'Account-Admin.php') ? 'disabled' : ''; ?>>
...
<div class="modal fade" id="EmailData" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h1 class="modal-title fs-5">Edit Email Service</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3 row">
                    <label for="SMTP_Email" class="col-sm-2 col-form-label">Email Address</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="SMTP_Email" placeholder="ex. Juandelacruz@example.com">
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="password" class="form-control" id="SMTP_Password" placeholder="Email Password">
                            <span class="input-group-text" style="cursor: pointer;" id="SMTPEye">
                                <svg class="bi pe-none text-muted" width="16" height="16" id="SMTP-label">
                                    <use xlink:href="#Visible" />
                                </svg>
                            </span>
                        </div>
            ...
            <div class="modal-footer border-0">
                <button type="button" class="btn btn-sm btn-primary" id="SaveSMTP">Save changes</button>
            </div>
        </div>
    </div>
</div>